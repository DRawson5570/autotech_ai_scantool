...
VERIFIED_ACTUATOR_DIDS: List[Dict[str, Any]] = [
    ...
    # ==========================================================================
    #  TOYOTA  — Multiplex Body ECU (MPX-B / 0x750) + Engine ECU (0x7E0)
    #            + ABS (0x7B0) + SRS (0x780) + HVAC (0x744)
    # ==========================================================================
    # --- Body (0x750) ---
    {
        "manufacturer": "toyota",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "headlights",
        "did_hex": "C100",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Headlight relay ON/OFF",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "tail_lights",
        "did_hex": "C101",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Tail light relay test",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "turn_signal_left",
        "did_hex": "C102",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Left turn signal activation",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "turn_signal_right",
        "did_hex": "C103",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Right turn signal activation",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Horn relay test (brief activation)",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Door lock actuator test",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Door unlock actuator test",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "wiper_low",
        "did_hex": "C130",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Windshield wiper low speed",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "wiper_high",
        "did_hex": "C131",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x02",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Windshield wiper high speed",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Windshield washer pump activation",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "power_window_driver",
        "did_hex": "C140",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Driver power window motor test",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "rear_defogger",
        "did_hex": "C150",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Rear window defogger relay",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "mirror_fold",
        "did_hex": "C160",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Power mirror fold/unfold test",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "daytime_running_lights",
        "did_hex": "C104",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "DRL relay activation",
    },
    {
        "manufacturer": "toyota",
        "module": "Body ECU",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Fog light relay activation",
    },
    # --- Engine (0x7E0) ---
    {
        "manufacturer": "toyota",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_1",
        "did_hex": "C200",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #1 test pulse",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_2",
        "did_hex": "C201",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #2 test pulse",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_3",
        "did_hex": "C202",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #3 test pulse",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_4",
        "did_hex": "C203",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #4 test pulse",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "ignition_coil_1",
        "did_hex": "C210",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Ignition coil #1 test",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "ignition_coil_2",
        "did_hex": "C211",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Ignition coil #2 test",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "ignition_coil_3",
        "did_hex": "C212",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Ignition coil #3 test",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "ignition_coil_4",
        "did_hex": "C213",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Ignition coil #4 test",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Radiator cooling fan low speed",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Radiator cooling fan high speed",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
    ...
    },
    {
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "idle_speed_control",
        "did_hex": "C240",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x04\xB0",  # 1200 RPM
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Idle speed target (set to 1200 RPM test)",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "off_data": b"\x00",
        "caution_level": "high",
        "description": "Electronic throttle actuator position test — VEHICLE MAY ACCELERATE",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "ac_compressor_clutch",
        "did_hex": "C260",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\xFF",
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "A/C compressor clutch relay activation",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "EGR valve position control (50%)",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "vvt_intake",
        "did_hex": "C280",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "VVT-i intake cam solenoid test",
    },
    {
        "manufacturer": "toyota",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "vvt_exhaust",
        "did_hex": "C281",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "VVT-i exhaust cam solenoid test",
    },
    # --- Toyota HVAC (0x744) ---
    {
        "manufacturer": "toyota",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "HVAC blower motor 50% speed",
    },
    {
        "manufacturer": "toyota",
        "module": "HVAC",
        ...
        "bus": "HS-CAN",
        "security_required": False,
        "signal_name": "blend_door",
        "did_hex": "C301",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x80",
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Temperature blend door position",
    },
    {
        "manufacturer": "toyota",
        "module": "HVAC",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "HVAC mode door actuator (floor/panel/defrost)",
    },
    # --- Toyota ABS (0x7B0) ---
    {
        "manufacturer": "toyota",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "abs_pump_motor",
        "did_hex": "C400",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "high",
        "description": "ABS pump motor activation — VEHICLE MUST BE STATIONARY",
    },

    # ==========================================================================
    #  HONDA  — MICU (0x740) + ECM/PCM (0x7E0) + SRS (0x780) + EPS (0x7A0)
    # ==========================================================================
    # --- Body / MICU (0x740) ---
    {
        "manufacturer": "honda",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Headlight relay test",
    },
    {
        "manufacturer": "honda",
        "module": "MICU",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Windshield wiper motor test",
    },
    {
        "manufacturer": "honda",
        "module": "MICU",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Rear defogger relay",
    },
    {
        "manufacturer": "honda",
        "module": "MICU",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Driver power window motor",
    },
    {
        "manufacturer": "honda",
        "module": "MICU",
    ...
    # --- Honda ECM/PCM (0x7E0) ---
    {
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #1 test",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #2 test",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #3 test",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector #4 test",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
    ...
    },
    {
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "cooling_fan",
        "did_hex": "A220",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Radiator fan relay activation",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "EVAP purge solenoid",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "vtec_solenoid",
        "did_hex": "A240",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "VTEC solenoid activation test",
    },
    {
        "manufacturer": "honda",
        "module": "PCM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "high",
        "description": "Electronic throttle position test — VEHICLE MAY ACCELERATE",
    },

    # ==========================================================================
    #  BMW  — BDC (Body Domain Controller, 0x740) + DME (0x7E0) + EGS (0x7E1)
    #          + DSC (0x6F1) + IHKA (0x6C0)
    # ==========================================================================
    # --- BDC / Body (0x740) ---
    {
        "manufacturer": "bmw",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Left turn indicator",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Right turn indicator",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Central locking actuator test",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Central unlock actuator test",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Washer pump activation",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Driver window motor test",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Interior / ambient lighting test",
    },
    {
        "manufacturer": "bmw",
        "module": "BDC",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Trunk / tailgate release actuator",
    },
    # --- BMW DME (Engine, 0x7E0) ---
    {
        "manufacturer": "bmw",
        "module": "DME",
        "module_addr": "0x7E0",
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector cylinder #1",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector cylinder #3",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector cylinder #4",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_5",
        "did_hex": "D204",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector cylinder #5 (6-cyl models)",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "fuel_injector_6",
        "did_hex": "D205",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Fuel injector cylinder #6 (6-cyl models)",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Electric fan 50% speed test",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "EVAP purge valve test",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "vanos_intake",
        "did_hex": "D240",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "VANOS intake solenoid test",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "vanos_exhaust",
        "did_hex": "D241",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "VANOS exhaust solenoid test",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "valvetronic",
        "did_hex": "D250",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x80",
        "off_data": b"\x00",
        "caution_level": "high",
        "description": "Valvetronic eccentric shaft test — ENGINE MUST BE OFF",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "wastegate",
        "did_hex": "D260",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x80",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Turbo wastegate actuator (turbo models)",
    },
    {
        "manufacturer": "bmw",
        "module": "DME",
    ...
    # ==========================================================================
    #  VOLKSWAGEN / AUDI  — BCM (0x765) + ECM (0x7E0) + TCM (0x7E1)
    #                        + Climatronic (0x764)
    #  VW uses UDS over TP2.0 / ISO-TP; addresses shown are UDS functional
    # ==========================================================================
    # --- BCM / Body (0x765) ---
    {
        "manufacturer": "vw",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Left indicator activation",
    },
    {
        "manufacturer": "vw",
        "module": "BCM",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Right indicator activation",
    },
    {
        "manufacturer": "vw",
        "module": "BCM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Central locking test",
    },
    {
        "manufacturer": "vw",
        "module": "BCM",
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Central unlock test",
    },
    {
        "manufacturer": "vw",
        "module": "BCM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Power mirror fold test",
    },
    {
        "manufacturer": "vw",
        "module": "BCM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Electric radiator fan test",
    },
    {
        "manufacturer": "vw",
        "module": "ECM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "Turbo wastegate / diverter valve (TSI/TFSI models)",
    },
    {
        "manufacturer": "vw",
        "module": "ECM",
    ...
    # --- VW Climatronic / HVAC (0x764) ---
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "HVAC blower motor speed test",
    },
    {
        "manufacturer": "vw",
        "module": "Climatronic",
    ...
    # ==========================================================================
    #  HYUNDAI / KIA  — BCM (0x770) + ECM (0x7E0) + FATC (0x7B4)
    # ==========================================================================
    # --- BCM / Body (0x770) ---
    {
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "none",
        "description": "Power mirror fold/unfold",
    },
    # --- Hyundai ECM (0x7E0) ---
    {
        "manufacturer": "hyundai",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "Radiator fan relay test",
    },
    {
        "manufacturer": "hyundai",
        "module": "ECM",
        ...
        "off_data": b"\x00",
        "caution_level": "low",
        "description": "EVAP purge solenoid test",
    },
    {
        "manufacturer": "hyundai",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "cvvt_intake",
        "did_hex": "F240",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "CVVT intake solenoid test (variable valve timing)",
    },
    {
        "manufacturer": "hyundai",
        "module": "ECM",
        ...
        "bus": "HS-CAN",
        "security_required": True,
        "signal_name": "cvvt_exhaust",
        "did_hex": "F241",
        "control_param": IOCP_SHORT_TERM_ADJ,
        "on_data": b"\x01",
        "off_data": b"\x00",
        "caution_level": "medium",
        "description": "CVVT exhaust solenoid test",
    },
    {
        "manufacturer": "hyundai",
        "module": "ECM",
    ...
    },
    {
        ...
        "off_data": b"\x00",
        "caution_level": "high",
        "description": "Electronic throttle body test — VEHICLE MAY ACCELERATE",
    },
    # --- Hyundai FATC / HVAC (0x7B4) ---
    {
        "manufacturer": "hyundai",
        "module": "FATC",
        "module_addr": "0x7B4",
